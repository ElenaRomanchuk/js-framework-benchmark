...
const ListContextState = React.createContext();
...
function Main () {
  ...
  return (<div className="container">
    <ListContextState.Provider value={state}>
      <ListContextDispatch.Provider value={dispatch}>
        <Jumbotron />
        <CustomTable/>
...
function Jumbotron () {
  const dispatch = React.useContext(ListContextDispatch);
  return (
...
function CustomTable () {
  const state = React.useContext(ListContextState);
  const dispatch = React.useContext(ListContextDispatch);
